...
@WebServlet("/addOneProduct")
public class AddOneProductController extends AbstractProductController {
	...
	protected void processProductForm(ProductForm form, ShoppingCart shoppingCart, HttpServletRequest req, HttpServletResponse resp) 
		...
		getOrderService().addOneProductToShoppingCart(form, shoppingCart);
